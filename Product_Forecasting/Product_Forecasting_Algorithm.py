...
# from darts.utils.utils import mean
...
def forecast(df, product_name,  value_string, path, retrain=False, forecast_horizon=6):
    ...
    if retrain:
        ...
        parameters = {"forecasting_models": [[NaiveSeasonal(K=12), LinearRegressionModel(lags=[-12, -24])],
                                             ...
                                             [NaiveSeasonal(K=12), LinearRegressionModel(lags=24)],
                                             [NaiveSeasonal(K=12), LinearRegressionModel(lags=12)]]}
        ...
        #Prophet
        parameters = {"add_seasonalities": [{'name': "monthly_seasonality", 'seasonal_periods': 12, 'fourier_order': 8, 'mode': 'additive'},
                                            {'name': "monthly_seasonality", 'seasonal_periods': 12, 'fourier_order': 8, 'mode': 'multiplicative'}, ]}
        ...
        print('NaiveSeasonal Scores. Historical: ', score_ns, ' Test: ', mape_score_ns)
